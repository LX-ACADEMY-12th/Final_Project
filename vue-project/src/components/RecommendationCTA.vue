  ...
  <div class="cta-wrap" :class="{ inset: inset }">
    <div class="cta-inner">
      ...
      <div class="cta-actions">
        <!-- props(primaryText)와 disabled 속성 다시 연결 -->
        <button class="btn btn-primary" type="button" :disabled="primaryDisabled || primaryLoading"
        ...
        <!--  disabled 속성 다시 연결 -->
        <button class="btn btn-secondary" type="button" :disabled="secondaryDisabled || secondaryLoading"
