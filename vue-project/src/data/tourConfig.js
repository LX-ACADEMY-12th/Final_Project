...
export const courseDemo = {
  ...
  scenes: {
    ...
    hall_1_entrance: {
      ...
      hotSpots: [
        ...
        // (2) 다음 관으로 건너뛰기 (간격 벌림)
        {
          ...
          yaw: 60,
          type: 'scene',
          text: '바로 다음 관 이동 (과학기술관)',
          sceneId: 'hall_3_entrance',
        },

        // (3) ❌ 종료 버튼 (모든 화면 공통)
        { pitch: -30, yaw: 90, type: 'info', text: '미리보기를 종료합니다.' },
      ],
    },
    // --- 창의나래관 시퀀스 ---
    hall_1_seq_1: {
      ...
      hotSpots: [
        ...
        { pitch: -30, yaw: 90, type: 'info', text: '미리보기를 종료합니다.' }, // 추가됨
      ],
    },
    hall_1_seq_2: {
      title: '가상현실라이더',
    ...
    hall_3_entrance: {
      ...
      type: 'equirectangular',
      panorama:
        'https://storage.googleapis.com/virtual_tour_team4/Science_and_Technology_Hall_02.png',
      hotSpots: [
        // (1)  전시물 순서대로
        {
          pitch: -5,
    ...
    hall_3_seq_1: {
      ...
      type: 'equirectangular',
      panorama:
        'https://storage.googleapis.com/virtual_tour_team4/Science_and_Technology_OutdoorNPark.jpg',
      hotSpots: [
    ...
    hall_3_seq_2: {
      ...
      type: 'equirectangular',
      panorama:
        'https://storage.googleapis.com/virtual_tour_team4/Science_and_Technology_Neighbor.jpg',
      hotSpots: [
    ...
    hall_3_seq_3: {
      ...
      type: 'equirectangular',
      panorama:
        'https://storage.googleapis.com/virtual_tour_team4/Science_and_Technology_Physics.jpg',
      hotSpots: [
    ...
    hall_3_seq_4: {
      ...
      type: 'equirectangular',
      panorama:
        'https://storage.googleapis.com/virtual_tour_team4/Science_and_Technology_HistoryOfScienceNTechnologyInKorea.jpg',
      hotSpots: [
        {
          pitch: 0,
          yaw: 0,
...
export const Course_2_Out_Chang_Sci = {
  ...
  scenes: {
    ...
    hall_1_seq_1: {
      ...
      panorama: 'https://storage.googleapis.com/virtual_tour_team4/Changui_Narae_PhygitalShow.jpg',
      hotSpots: [
        { pitch: 0, yaw: 0, type: 'scene', text: '다음 (2/4)', sceneId: 'hall_1_seq_2' },
        { pitch: 0, yaw: 180, type: 'scene', text: '뒤로', sceneId: 'hall_1_entrance' },
        { pitch: -30, yaw: 90, type: 'info', text: '종료' },
      ],
    },
    hall_1_seq_2: {
      ...
      panorama: 'https://storage.googleapis.com/virtual_tour_team4/Changui_Narae_VRRider.jpg',
      hotSpots: [
        { pitch: 0, yaw: 0, type: 'scene', text: '다음 (3/4)', sceneId: 'hall_1_seq_3' },
        { pitch: 0, yaw: 180, type: 'scene', text: '뒤로', sceneId: 'hall_1_seq_1' },
        { pitch: -30, yaw: 90, type: 'info', text: '종료' },
      ],
    },
    hall_1_seq_3: {
      ...
      panorama: 'https://storage.googleapis.com/virtual_tour_team4/Changui_Narae_POPDRONE.jpg',
      hotSpots: [
        { pitch: 0, yaw: 0, type: 'scene', text: '다음 (4/4)', sceneId: 'hall_1_seq_4' },
        { pitch: 0, yaw: 180, type: 'scene', text: '뒤로', sceneId: 'hall_1_seq_2' },
        { pitch: -30, yaw: 90, type: 'info', text: '종료' },
      ],
    },
    ...
    hall_3_seq_1: {
      ...
      panorama:
        'https://storage.googleapis.com/virtual_tour_team4/Science_and_Technology_OutdoorNPark.jpg',
      hotSpots: [
        { pitch: 0, yaw: 0, type: 'scene', text: '다음 (2/4)', sceneId: 'hall_3_seq_2' },
        { pitch: 0, yaw: 180, type: 'scene', text: '뒤로', sceneId: 'hall_3_entrance' },
        { pitch: -30, yaw: 90, type: 'info', text: '종료' },
      ],
    },
